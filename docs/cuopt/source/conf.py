...
project = "AMD ROCm cuOpt"
copyright = f"2021-{datetime.datetime.today().year}, Advanced Micro Devices, Inc."
...
version = f"{CUOPT_VERSION.major}.{CUOPT_VERSION.minor}"
# The full version.
release = f"{CUOPT_VERSION.major}.{CUOPT_VERSION.minor}.{CUOPT_VERSION.micro}"
