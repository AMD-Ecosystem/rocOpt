...
extern __constant__ double default_reduction_exponent;
extern __constant__ double default_growth_exponent;
extern __constant__ double default_primal_weight_update_smoothing;
extern __constant__ double default_sufficient_reduction_for_restart;
extern __constant__ double default_necessary_reduction_for_restart;
extern __constant__ double primal_importance;
extern __constant__ double primal_distance_smoothing;
extern __constant__ double dual_distance_smoothing;
