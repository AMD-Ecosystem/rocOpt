  ...
  i_t total_pdlp_iterations)
{
  ...
  if (!graph.is_initialized(total_pdlp_iterations)) {
    ...
    RAFT_CUDA_TRY(hipcub::DeviceTransform::Transform(
      thrust::make_zip_iterator(thrust::make_tuple(sum_primal_solutions_.data(), primal_solution)),
    ...
    RAFT_CUDA_TRY(hipcub::DeviceTransform::Transform(
      thrust::make_zip_iterator(thrust::make_tuple(sum_dual_solutions_.data(), dual_solution)),
